...
export const MODES: Record<GameMode, ModeDef> = {
  free: {
    ...
    short: "Полёт",
    blurb: "Полигон без задачи. ЗРК и БМП бьют по борту, колонны едут по грунтовке, посадка на площадке заряжает АКБ и БК.",
    start: "В воздух",
    seat: "fpv",
    win: "none",
  },
  ...
  assault: {
    ...
    title: "Штурм",
    short: "Прорыв",
    blurb: "Солдат или пикап от третьего лица. Дойти до ленты, прячась от охотничьих FPV — в рощах захват сбрасывается быстрее. T слух, N тепло.",
    start: "На штурм",
    seat: "ground",
    win: "reach-line",
  },
