          ...
          {ground ? (
            <>
              ...
              <p className="mt-2 text-[11px] leading-snug text-subtle coarse:hidden">
                ...
                красную ленту. Ночью горят окна и лучи охотников. В рощах и у домов захват сбрасывается быстрее. T — пеленг FPV. N — тепловизор.
              </p>
            ...
            <>
              ...
              <p className="mt-2 hidden text-[11px] leading-snug text-subtle coarse:hidden md:block">
                {arcade
                  ...
                  : "Полигон: ЗРК ловит высоту — жмите к земле и за дома. Колонны по грунтовке. Сядьте на площадку: АКБ и БК капают. Скан (T), автоприцел, тепло (N)."}
              </p>
            </>
          )}
        </div>
